...
<div class="px-10 bg-white py-5 rounded-3 shadow-lg dark:bg-slate-850 dark:shadow-dark-xl">
    ...
    <div class="flex justify-between py-5">
        ...
        <a href="{{ route('user.addjob') }}" class="bg-blue-500 px-5 py-2 text-[14px] text-white rounded-2 cursor-pointer">
            Add Job
        </a>
    </div>
    <div class="flex py-5">
                    ...
                    <tbody>
                        ...
                        <tr class="parent">
                            ...
                            <td
                                ...
                                <a href="{{ route('user.viewjob', $item->id) }}" class="py-2.5 px-3 bg-blue-500 rounded-1 text-white">
                                    <i class="fa-solid fa-eye"></i>
                                </a>
                                <a href="{{ route('user.jobedit', $item->id) }}" class="py-2.5 px-3 bg-blue-500 rounded-1 text-white">
                                    <i class="fa-solid fa-pen-to-square"></i>
                                </a>
                                <a data-url="{{ route('user.deletjob', $item->id) }}" onclick="confirm(this)" class="py-2.5 px-3 bg-red-500 rounded-1 text-white cursor-pointer">

...
class InterviewController extends Controller
{
    ...
    public function submitinterview(Request $request){
        ...
        return redirect('/interview')->with('message', 'Interview Inserted Successfully');
    }
    ...
    public function updateinterview(Request $request){
        ...
        return redirect('/interview')->with('message', 'Interview Updated Successfully');
    }
    ...
    public function submicandidatetinterview(Request $request){
        ...
        return redirect('/candidate-interview')->with('message', 'Interview Inserted Successfully');
    }

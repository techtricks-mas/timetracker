...
class InterviewController extends Controller
{
    ...
    public function candidate_interview()
    {
        ...
        return view('Pages.User.Cinterview.Interview', compact('page', 'data', 'currentdate'));
    }
    ...
    public function CWeekDatadate($date)
    {
        ...
        return view('Pages.User.Cinterview.Interview', compact('page', 'data', 'dates', 'currentdate'));
    }

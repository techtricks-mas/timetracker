...
@section('content')
    <div class="px-10 bg-white py-5 rounded-3 shadow-lg dark:bg-slate-850 dark:shadow-dark-xl">
        <div class="flex justify-between">
            <h6 class="text-slate-700 text-xl dark:text-white">View Candidate Interview</h6>
        </div>
        <div>
            <form>
                <div class="md:flex py-3">
                    <div class="w-full md:w-1/2 md:mr-2">
                        ...
                        <input id="name" type="text"  value="{{ $data->name }}" disabled
                            class="px-3 py-2 rounded-2 border border-black focus:outline-none w-full dark:bg-slate-850 dark:border-white dark:text-white"
                            name="name" />
                    </div>
                    <div class="w-full md:w-1/2 md:ml-2">
                        ...
                        <input id="email" type="email"  value="{{ $data->email }}" disabled
                            class="px-3 dark:bg-slate-850 dark:border-white dark:text-white py-2 rounded-2 border border-black focus:outline-none w-full"
                            name="email" />
                    </div>
                </div>
                <div class="md:flex py-3">
                ...
                <div class="md:flex py-3">
                    <div class="w-full md:w-1/2 md:mr-2">
                        ...
                        <select value="{{ $data->status }}" disabled
                            class="px-3 py-2 w-full border-black focus:outline-none rounded-2 dark:bg-slate-850 dark:border-white dark:text-white"
                            name="status">

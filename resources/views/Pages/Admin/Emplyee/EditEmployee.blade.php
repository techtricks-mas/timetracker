...
<div class="px-10 bg-white py-5 rounded-3 shadow-lg">
    <div class="flex justify-between">
        <h6 class="text-slate-700 text-xl">Edit Employee</h6>
    </div>
    <div>
        <form method="POST" action="{{ url('/updateemployee') }}" name="form">
            <div class="md:flex py-3">
                <div class="w-full md:w-1/2 md:mr-2">
                    ...
                    <input id="firstName" value="{{ $employee->fname }}" type="text" class="@error('firstname') border-red-500 @enderror px-3 py-2 rounded-2 border border-black focus:outline-none w-full" name="firstname"/>
                    @error('firstname')
                ...
                <div class="w-full md:w-1/2 md:ml-2">
                    ...
                    <input id="lastName" value="{{ $employee->lname }}" type="text" class="@error('lastname') border-red-500 @enderror px-3 py-2 rounded-2 border border-black focus:outline-none w-full" name="lastname"/>
                    @error('lastname')
                        <p class="alert alert-danger text-red-500 text-sm">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="md:flex py-3">
                <div class="w-full md:w-1/2 md:mr-2">
                    ...
                    <input id="workemail" value="{{ $employee->workemail }}" type="email" class="@error('workemail') border-red-500 @enderror px-3 py-2 rounded-2 border border-black focus:outline-none w-full" name="workemail"/>
                    @error('workemail')
                        <p class="alert alert-danger text-red-500 text-sm">{{ $message }}</p>
                    @enderror
                </div>
                <div class="w-full md:w-1/2 md:ml-2">
                    ...
                    <input id="persoanlemail" value="{{ $employee->personalemail }}" type="email" class="@error('personalemail') border-red-500 @enderror px-3 py-2 rounded-2 border border-black focus:outline-none w-full" name="personalemail"/>
                    @error('personalemail')
                        <p class="alert alert-danger text-red-500 text-sm">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="md:flex py-3">
                <div class="w-full md:w-1/2 md:mr-2">
                    ...
                    <select class="@error('country') border-red-500 @enderror px-3 py-2 w-full border-black focus:outline-none rounded-2" name="country">
                ...
                <div class="w-full md:w-1/2 md:ml-2">
                    ...
                    <input id="number" value="{{ $employee->phone }}" type="number" name="phone" class="@error('phone') border-red-500 @enderror px-3 py-2 rounded-2 border border-black focus:outline-none w-full"/>
                    @error('phone')
                        <p class="alert alert-danger text-red-500 text-sm">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="md:flex py-3">
                <div class="w-full md:w-1/2 md:mr-2">
                    ...
                    <select class="px-3 py-2 w-full border-black focus:outline-none rounded-2" name="role">
                ...
                <div class="w-full md:w-1/2 md:ml-2">
                    ...
                    <select class="@error('type') border-red-500 @enderror px-3 py-2 w-full border-black focus:outline-none rounded-2" name="type">
            ...
            <div class="py-3">
                <div class="md:flex">
                    <div class="w-full md:w-1/2 md:mr-2">
                        ...
                        <input class="@error('wstart') border-red-500 @enderror timepicker px-3 py-2 rounded-2 border border-black focus:outline-none w-full" name="wstart" value="{{ $employee->wstart }}"/>
                        @error('wstart')
                            <p class="alert alert-danger text-red-500 text-sm">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="w-full md:w-1/2 md:ml-2">
                        ...
                        <input class="@error('wend') border-red-500 @enderror timepicker px-3 py-2 rounded-2 border border-black focus:outline-none w-full" name="wend" value="{{ $employee->wend }}"/>
                        @error('wend')
                            <p class="alert alert-danger text-red-500 text-sm">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <div class="md:flex py-3">
                <div class="w-full md:w-1/2 md:mr-2">
                    ...
                    <input id="dhours" value="{{ $employee->dhours }}" name="dhours" type="number" class="@error('dhours') border-red-500 @enderror px-3 py-2 rounded-2 border border-black focus:outline-none w-full"/>
                    @error('dhours')
                        <p class="alert alert-danger text-red-500 text-sm">{{ $message }}</p>
                    @enderror
                </div>
                <div class="w-full md:w-1/2 md:ml-2">
                    ...
                    <input id="whours" name="whours" value="{{ $employee->whours }}" type="number" class="@error('dhours') border-red-500 @enderror px-3 py-2 rounded-2 border border-black focus:outline-none w-full"/>
                    @error('whours')
                        <p class="alert alert-danger text-red-500 text-sm">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="md:flex py-3">
                <div class="w-full md:w-1/2 md:mr-2">
                    ...
                    <input id="jdate" name="jdate" value="{{ $employee->jdate }}" type="date" class="@error('jdate') border-red-500 @enderror px-3 py-2 rounded-2 border border-black focus:outline-none w-full"/>
                    @error('jdate')
                        <p class="alert alert-danger text-red-500 text-sm">{{ $message }}</p>
                    @enderror
                </div>
                <div class="w-full md:w-1/2 md:ml-2">
                    ...
                    <select class="@error('status') border-red-500 @enderror px-3 py-2 w-full border-black focus:outline-none rounded-2" name="status">
            ...
            <div class="py-3">
                <div class="w-full">
                    ...
                    <input id="designation" value="{{ $employee->designation }}" name="designation" type="text" class="@error('designation') border-red-500 @enderror px-3 py-2 rounded-2 border border-black focus:outline-none w-full"/>
                    @error('designation')
                        <p class="alert alert-danger text-red-500 text-sm">{{ $message }}</p>
                    @enderror
                </div>

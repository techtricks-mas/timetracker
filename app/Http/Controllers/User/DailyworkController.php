...
class DailyworkController extends Controller
{
    public function dailywork()
    {
        ...
        $id = null;
        return view('Pages.User.DailyWork.Dailywork', compact('data', 'page', 'users', 'id'));
    }
    ...
    public function adddailywork()
    {
        ...
        return view('Pages.User.DailyWork.AddDailyWork', compact('employees', 'page'));
    }
    ...
    public function viewdailywork($id)
    {
        ...
        return view('Pages.User.DailyWork.ViewWork', compact('data', 'page'));
    }
    ...
    public function submitdailywork(Request $request)
    {
        ...
        return redirect()->route('user.dailywork')->with('message', 'Daily Work Added Successfully');
    }
    ...
    public function dailyworkedit($id)
    {
        ...
        $employees = Employee::where('status', '1')->get();
        $data = DailyWork::where('id', $id)->first();
        return view('Pages.User.DailyWork.EditDailyWork', compact('employees', 'data', 'page'));
    }
    ...
    public function updatedailywork(Request $request)
    {
        ...
        return redirect()->route('user.dailywork')->with('message', 'Daily Work Updated Successfully');
    }
}

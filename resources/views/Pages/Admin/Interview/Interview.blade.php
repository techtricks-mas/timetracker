                    ...
                    <tbody>
                        ...
                        <tr class="parent">
                            ...
                            <td
                                ...
                                <div class="flex px-2 py-1">
                                    <div class="flex flex-col justify-center">
                                        <h6 class="mb-0 text-sm leading-normal dark:text-slate-400">{{ $item->name }}</h6>
                            ...
                            <td
                                class="p-2 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent">
                                <span
                                    class="text-xs font-semibold leading-tight dark:text-slate-400  text-slate-400">{{ $item->time }}</span>
                            </td>
                            <td

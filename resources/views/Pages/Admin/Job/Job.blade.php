...
<div class="px-10 bg-white py-5 rounded-3 shadow-lg dark:bg-slate-850 dark:shadow-dark-xl">
    ...
    <div class="flex justify-between py-5">
        ...
        <a href="{{ route('admin.addjob') }}" class="bg-blue-500 px-5 py-2 text-[14px] text-white rounded-2 cursor-pointer">
            Add Job
        </a>
    </div>
    <div class="flex py-5">
        <div class="mr-3 bg-white shadow-2xl dark:bg-slate-850 dark:shadow-dark-2xl rounded-xl bg-clip-border px-6 py-2">Total Jobs: <span class="font-bold text-xl">{{$totalCount}}</span></div>
        <div class="mr-3 bg-white shadow-2xl dark:bg-slate-850 dark:shadow-dark-2xl rounded-xl bg-clip-border px-6 py-2">Accepted Jobs: <span class="font-bold text-xl">{{$approvedCount}}</span></div>
        <div class="mr-3 bg-white shadow-2xl dark:bg-slate-850 dark:shadow-dark-2xl rounded-xl bg-clip-border px-6 py-2">Rejected Jobs: <span class="font-bold text-xl">{{$rejectCount}}</span></div>
        <div class="bg-white shadow-2xl dark:bg-slate-850 dark:shadow-dark-2xl rounded-xl bg-clip-border px-6 py-2">Waiting for Review: <span class="font-bold text-xl">{{$waitCount}}</span></div>
    </div>
    <div>
                    ...
                    <tbody>
                        ...
                        <tr class="parent">
                            ...
                            <td
                                ...
                                <a href="{{ route('admin.viewjob', $item->id) }}" class="py-2.5 px-3 bg-blue-500 rounded-1 text-white">
                                    <i class="fa-solid fa-eye"></i>
                                </a>
                                <a href="{{ route('admin.jobedit', $item->id) }}" class="py-2.5 px-3 bg-blue-500 rounded-1 text-white">
                                    <i class="fa-solid fa-pen-to-square"></i>
                                </a>
                                <a data-url="{{ route('admin.deletjob', $item->id) }}" onclick="confirm(this)" class="py-2.5 px-3 bg-red-500 rounded-1 text-white cursor-pointer">

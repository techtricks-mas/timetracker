...
class DailyworkController extends Controller
{
    public function dailywork()
    {
        ...
        $data = DailyWork::orderBy('id', 'desc')->paginate(15);
        $id = null;
        return view('Pages.Admin.DailyWork.Dailywork', compact('data', 'page', 'users', 'id'));
    }
    ...
    public function submitdailywork(Request $request)
    {
        ...
        return redirect()->route('admin.dailywork')->with('message', 'Daily Work Added Successfully');
    }
    ...
    public function updatedailywork(Request $request)
    {
        ...
        return redirect()->route('admin.dailywork')->with('message', 'Daily Work Updated Successfully');
    }
}

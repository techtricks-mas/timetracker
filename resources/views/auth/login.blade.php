                                ...
                                <form method="POST" action="{{ route('login') }}" name="form">
                                    ...
                                    <div class="mb-4">
                                        <input type="email" id="email" placeholder="Email" name="email"
                                            ...
                                            class="focus:shadow-primary-outline dark:bg-gray-950 dark:placeholder:text-black/80 dark:text-black/80 text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding p-3 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-fuchsia-300 focus:outline-none" />
                                    </div>
                                    <div class="mb-4">
